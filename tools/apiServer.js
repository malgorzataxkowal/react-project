...
server.post("/shoes/", function (req, res, next) {
...
function validateCourse(shoe) {
  if (!shoe.title) return "Title is required.";
  if (!shoe.price) return "Price is required.";
  if (!shoe.category) return "Category is required.";
  return "";
}
